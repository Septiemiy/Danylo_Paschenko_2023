...
namespace Task1
{
    public static class UserInterface
    {
        ...
        public static void MoveFileOrDirRequest()
        {
            while (true)
            {
                ...
                {
                    case "d":
                        MoveDirs.MoveDir(GetDirectoryPath(), GetNewPath());
                        continue;
                    case "f":
                        MoveFiles.MoveFile(GetFilePath(), GetNewPath());
                        continue;                
                    case "c":
                        break;
                    default:
        ...
        public static void RemoveFileOrDirRequest()
        {
            while (true)
            {
                ...
                {
                    case "d":
                        RemoveDirs.RemoveDir(GetDirectoryPath());
                        continue;
                    case "f":
                        RemoveFiles.RemoveFile(GetFilePath());
                        continue;
                    case "c":
                        break;
                    default:
        ...
        public static void CloneFileOrDirRequest()
        {
            while (true)
            {
                ...
                {
                    case "d":
                        CloneDirs.CloneDir(GetDirectoryPath());
                        continue;
                    case "f":
                        CloneFiles.CloneFile(GetFilePath());
                        continue;
                    case "c":
                        break;
                    default:
